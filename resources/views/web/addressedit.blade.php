                ...
                <div class="am-modal am-modal-no-btn" id="doc-modal-1">
                    ...
                    <div class="add-dress">
                        ...
                        <div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
                            <form class="am-form am-form-horizontal" action="/web/addressupdate/{{$post->id}}" method="post">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-form-label">收货人</label>
                                    <div class="am-form-content">
                                        <input type="text" name="name" value="{{$post->name}}" id="user-name" placeholder="收货人">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-content">
                                        <input id="user-phone" name="tel" value="{{$post->tel}}" placeholder="手机号必填" type="text">
                                    </div>
                                </div>
                                {{--<div class="am-form-group">--}}
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-content">
                                        <textarea class="" rows="3" name="address"  id="user-intro" placeholder="输入详细地址">{{$post->address}}</textarea>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-form-content">
                                        <input id="user-phone" name="emailno" value="{{$post->emailno}}" placeholder="选填" type="text">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <input type="submit" name="" value="保存地址" class="am-btn am-btn-primary am-btn-sm">
                                    </div>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <a href="{{url('web/address')}}"><input type="submit" name="" value="暂不修改" class="am-btn am-btn-primary am-btn-sm"></a>
                                </div>
