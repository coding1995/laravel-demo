...
@section('content')
    ...
    <div class="user-safety">
        ...
        <div class="user-infoPic">
            ...
            <div class="filePic">
                <img class="am-circle am-img-thumbnail" src="{{asset('uploads/_min'.session('webuser')[0]->pic)}}" alt="" />
            </div>
            ...
            <div class="info-m">
                <div><b>用户名：<i>{{session('webuser')[0]->username}}</i></b></div>
                <div class="safeText">
