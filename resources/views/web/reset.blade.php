    ...
    <div class="login-main">
        ...
        <div class="login-box">
            ...
            <div class="login-form">
                <form action="{{url('web/doreset')}}" method="post">
                    ...
                    <div class="user-pass">
                        <label for="password"><i class="am-icon-lock"></i></label>
                        <input type="password" name="repassword" id="password" placeholder="请确认输入的新密码。。">
                    </div>
            </div>
            <div class="am-cf">
                <input type="submit" name="" value="重置密码" class="am-btn am-btn-primary am-btn-sm">
            </div>
            </form>
