...
<link href="{{ asset('web/css/sustyle.css') }}" rel="stylesheet" type="text/css" />
   ...
   <div class="successInfo">
     <ul>
       ...
       <div class="user-info">
         ...
         <p>收货人：{{$addresses[0]->name}}</p>
         <p>联系电话：{{$addresses[0]->tel}}</p>
         <p>收货地址：{{$addresses[0]->address}}</p>
       </div>
     ...
     <div class="option">
       <span class="info">您可以</span>
        <a href="/order" class="J_MakePoint">查看<span>订单</span></a>  
     </div>
    </div>
  </div>
</div>
