            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        ...
                        @endif
                        <form class="am-form am-form-horizontal" action="/admin/role/update/{{$post->id}}" method="post">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">角色 / Role</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="name" value="{{$post->name}}" id="user-name" placeholder="">
                                    <small>请输入要修改的角色。。。</small>
                                </div>
                            </div>
