		...
		<form action="{{url('/admin/goods')}}">
			<div class="am-g">
				...
				<div class="am-u-sm-12 am-u-md-3" style="margin-left: -20px">显示：</div>
					...
					<div class="am-u-sm-12 am-u-md-3" style="margin-left: 200px">分类名：</div>
		...
		<div class="am-g">
			<div class="am-u-sm-12">
				<form class="am-form">
									...
									<div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
											<button class="am-btn am-btn-default am-btn-xs am-text-secondary">
												...
												<a href="/admin/goods/{{$v->id}}/edit">编辑</a>
											</button>
					...
					{!! $GoodSort->appends($request->only(['num','name']))->render() !!}
