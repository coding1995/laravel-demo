...
@section('content')
    ...
    <ol class="am-breadcrumb">
        ...
        <li><a href="#">会员信息</a></li>
        <li class="am-active">添加会员</li>
    </ol>
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 添加会员信息
            </div>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    ...
                    @endif
                    <form class="am-form am-form-horizontal" method="post" action="/admin/webuser" enctype="multipart/form-data">
                        ...
                        {{--<div class="am-form-group">--}}
                            {{--<label for="user-email" class="am-u-sm-3 am-form-label"> / Family</label>--}}
                            {{--<div class="am-u-sm-9">--}}
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input name="status" type="radio" value="1" checked="[]" />有效&nbsp;&nbsp;
