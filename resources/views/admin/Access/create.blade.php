            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        ...
                        @endif
                        <form class="am-form am-form-horizontal" action="{{url('admin/access/store')}}" method="post">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">权限标题 / Role</label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="title" id="user-name" placeholder="">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea class="" rows="5" name="urls" id="user-intro" placeholder="一行一个url。。"></textarea>
                                    <small></small>
                                </div>
                            </div>
